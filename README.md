...
A fast and minimalistic lib to manipulate images. Made specifically for Flutter.
...
Things like format encoding, EXIF and multi-frame images are not the concern of this package. If that is your need, check [`image`](https://pub.dartlang.org/packages/image).
...
**❗ In order to start using Bitmap you must have the [Flutter SDK][flutter_install_link] installed on your machine.**
...
### 1. Image to Bitmap conversion (decoding)
...
### 2. Applying some operations on the Bitmap
